...
<body>
	...
	<form action="../account/login.do" name="form" method="post" id="frm">
			...
			<div class="form-group">
						<input type="button" class="btn btn-block create-account" value="로그인" onclick="loginCheck()">
			</div>		
			<div class="form-group">
						<input type="button" class="btn btn-block create-account" value="회원가입" onclick="location.href='writeForm.do'" >
			</div>						
		</form>
	</div>
